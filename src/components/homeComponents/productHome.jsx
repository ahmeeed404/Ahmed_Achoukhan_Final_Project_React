            ...
            >
              <div className="relative group">
                ...
                <button
                  ...
                  className="absolute bottom-4 left-1/2 -translate-x-1/2 bg-black text-white px-4 py-2 opacity-0 group-hover:opacity-100 transition-opacity rounded"
                >
                  ADD TO CART
                </button>
              </div>
              ...
              <div className="p-4 text-center">
                <h3 className="text-sm md:text-base font-semibold">{product.title}</h3>
