...
function Contact() {
  ...
  const sendEmail = (e) => {
    e.preventDefault();
    const serviceId = "service_sk4dgdg";
    const templateId = "template_pg7kb4b";
    const publicKey = "tM0txBDo1s0YYimZ7";
    ...
    <div>
      ...
      <section className="text-gray-600 body-font relative">
        <div className="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
          <div className="lg:w-2/3 md:w-1/2 rounded-lg overflow-hidden p-10 flex items-end justify-start relative">
            <iframe
              width="80%"
              height="100%"
